...
class ChatStatistics:
    ...
    def get_top_users(self, top_n: int = 10) -> dict:
        ...
        :param top_n: number of users ti get, default to 10
        ...
        # get top usersbased on replying to questions from others    
    ...
    def generate_word_cloud(
        ...
        for msg in self.chat_data['messages']:
            if type(msg['text']) is str:
                ...
                tokens = list(
                    filter(lambda item: item not in self.stop_words, tokens)
                )
